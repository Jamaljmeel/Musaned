...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // The AuthWrapper handles navigation based on the role stored in Firestore
    } catch (e) {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('مرحباً بك مجدداً', style: TextStyle(fontSize: 16, color: AppColors.textSecondary)),
